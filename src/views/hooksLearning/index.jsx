...
import { useCount } from '../../hooks/user-hook'
...
export default function UseReducerDemo(props) {
    // 自定义hook
    const [countValue, addhook, minhook] = useCount(10)
    ...
    return (
        <div>
            ...
            我是自定义hook{countValue}
            <div>
                <Button onClick={() => { addhook(10) }} type="primary" size="small" inline>加多少</Button>
                <Button onClick={() => { minhook(10) }} style={{ marginLeft: "10px" }} type="info" size="small" inline>减多少</Button>
            </div>
